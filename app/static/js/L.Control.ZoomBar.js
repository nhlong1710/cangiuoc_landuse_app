...
L.Control.ZoomBar = L.Control.extend(
{
    ...
    onAdd: function(map)
    {
        ...
        this._zoomStartButton  = this._createButton('<i class="fas fa-expand"></i>', 'Zoom to Start Position',
        ...
        if( this._isSmallScreen()===false ){
            this._zoomToAreaButton = this._createButton('<i class="fas fa-search-plus"></i>', 'Zoom to Area',
